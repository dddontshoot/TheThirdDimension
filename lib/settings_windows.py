def getSettings():      # This file stores the file locations for your computer.
    ...
    settings["basePath"]="c:\games\Factorio\script-output\\" # Filenames in the command line will be relative to this path. use settings["basePath"]="" for no path.
    ...
    settings["outputPath"]="output\\"              # The output folder will house subfolders with a name that matches the .base file.
